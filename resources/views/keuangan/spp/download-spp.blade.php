    ...
    <div class="container">
        ...
        <table class="info-table">
            <tr>
                ...
                <td>: {{ $buktiSpp->siswa->nama }}</td>
            </tr>
            <tr>
                <td><strong>NISN</strong></td>
                <td>: {{ $buktiSpp->siswa->nisn }}</td>
            </tr>
            <tr>
                <td><strong>Kelas</strong></td>
                <td>: {{ $buktiSpp->siswa->kelas }}</td>
            </tr>
            <tr>
                <td><strong>Tahun</strong></td>
                <td>: {{ $buktiSpp->bulan }} / {{ $buktiSpp->tahun }}</td>
            </tr>
            <tr>
                <td><strong>Jumlah</strong></td>
                <td>: Rp {{ number_format($buktiSpp->jumlah, 0, ',', '.') }}</td>
            </tr>
            <tr>
                <td><strong>Status</strong></td>
                <td>: <span class="badge">{{ ucfirst($buktiSpp->status) }}</span></td>
            </tr>
            <tr>
                <td><strong>Tanggal Bayar</strong></td>
                <td>: {{ \Carbon\Carbon::parse($buktiSpp->tanggal_bayar)->format('d M Y') }}</td>
            </tr>
        </table>
