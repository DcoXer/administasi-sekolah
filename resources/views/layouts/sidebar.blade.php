    ...
    <nav class="p-4 space-y-3 font-medium text-gray-700">
        ...
        <div x-data="{ keuanganOpen: false }">
            <button @click="keuanganOpen = !keuanganOpen"
                class="flex items-center w-full p-3 rounded-lg hover:bg-green-50 transition-all duration-300">
            ...
            <div x-show="keuanganOpen" x-transition.scale.opacity class="ml-10 space-y-1">
                <a href="{{ route('daftar-ulang.index') }}" class="block py-2 text-sm hover:text-blue-700 text-gray-700">Pembayaran Daftar Ulang</a>
                <a href="{{ route('pembayaran-spp.index') }}" class="block py-2 text-sm hover:text-blue-700 text-gray-700">Pembayaran SPP Bulanan</a>
            </div>
        </div>
        @endif
        ...
        <div x-data="{ siswaOpen: false }">
            <button @click="siswaOpen = !siswaOpen"
                class="flex items-center w-full p-3 rounded-lg hover:bg-blue-50 transition-all duration-300">
            ...
            <div x-show="siswaOpen" x-transition.scale.opacity class="ml-10 space-y-1">
                <a href="{{ route('siswa.public') }}" class="block py-2 text-sm hover:text-blue-700 text-gray-700">Daftar Siswa</a>
                @if(Auth::user()->role === 'operator')
                <a href="{{ route('siswa.index') }}" class="block py-2 text-sm hover:text-blue-700 text-gray-700">Manajemen Siswa</a>
                <a href="{{ route('kelas.index') }}" class="block py-2 text-sm hover:text-blue-700 text-gray-700">Manajemen Kelas</a>
                @endif
            </div>
        </div>
        ...
        <div x-data="{ guruOpen: false }">
            <button @click="guruOpen = !guruOpen"
                class="flex items-center w-full p-3 rounded-lg hover:bg-purple-50 transition-all duration-300">
            ...
            <div x-show="guruOpen" x-transition.scale.opacity class="ml-10 space-y-1">
                <a href="{{ route('guru.public') }}" class="block py-2 text-sm hover:text-purple-700 text-gray-700">Daftar Guru</a>
                @if(Auth::user()->role === 'operator')
                <a href="{{ route('guru.index') }}" class="block py-2 text-sm hover:text-purple-700 text-gray-700">Manajemen Guru</a>
                @endif
            </div>
        </div>
