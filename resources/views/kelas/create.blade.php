        ...
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="liquid-card">
                <div class="mb-8 pb-4 border-b border-gray-200">
                    <h2 class="text-2xl font-bold text-gray-800">Tambah Data Kelas</h2>
                    <p class="text-sm text-gray-600 mt-1">Lengkapi form di bawah untuk menambahkan kelas baru</p>
                </div>
                ...
                <form action="{{ route('kelas.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1.5">Masukkan nama kelas sesuai format sekolah (contoh: X IPA 1, XI IPS 2, XII MIPA 3)</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1.5">Pilih guru yang akan menjadi wali kelas untuk kelas ini</p>
                        </div>
                    </div>
